...
<div class="card container h-full w-full px-6 md:px-16 pt-4">
	...
	<div class="m-10 mx-auto md:w-3/4 w-full rounded-md border-gray-400 border p-5">

		{#if templateInfo}
			<Card.Root>
				<div class=" relative mx-auto h-fit rounded-md border border-gray-400  pb-7 pt-5">
