...
<div class="card container my-12 h-screen w-full px-6 pt-4 md:px-8">
	<Breadcrumb.Root>
	...
	<div
		class="mx-auto w-full my-10 shadow-md p-3 rounded-md border border-gray-400  dark:bg-[#0a0a0b] md:w-3/4"
	>
		{#if templateInfo}
			<Card.Root>
				<div
					class=" relative mx-auto rounded-md border border-gray-400 py-4 dark:bg-[#0a0a0b]"
				>
					<div class="flex h-full flex-col items-center justify-center">
						...
						<div class="relative w-full p-4">
							...
							<span class="absolute mx-4 right-0 -bottom-3 -translate-y-1/2 text-sm text-gray-700">
