<script lang="ts">
	...
	import ValidationLogicIntegration from '../../../validation/ValidationLogicIntegration.svelte';
	import SkipLogicIntegration from '../../../skip-logic/SkipLogicIntegration.svelte';
